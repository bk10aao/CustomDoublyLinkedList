...
custom_csv = os.path.join(script_dir, "CustomDoublyLinkedListJmhBenchmark.csv")
jdk_csv = os.path.join(script_dir, "LinkedList_performance.csv")

# ---------------------------------------------------------------------------
# Load CSV results
# ---------------------------------------------------------------------------
custom_df = pd.read_csv(custom_csv, sep=None, engine='python')
...
# Plotting
# ---------------------------------------------------------------------------
color_custom = "#ff4d4d"  # Red for Custom Doubly Linked List
color_native = "#4da6ff"  # Blue for JDK LinkedList
