...
# Load data files
cdll_df = pd.read_csv('CustomDoublyLinkedListJmhBenchmark.csv', sep=';')
ll_df = pd.read_csv('CustomLinkedListJmhBenchmark.csv', sep=';')
...
ax.set_title(
    'CustomLinkedList vs CustomDoublyLinkedList Performance Comparison Matrix Heatmap\n(Positive/Blue = V2 Faster, Negative/Red = V1 Faster)',
